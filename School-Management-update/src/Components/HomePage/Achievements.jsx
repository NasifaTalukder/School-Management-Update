  ...
  const achievements = [
    {
      ...
      description:
        "Our school has achieved the highest academic performance in the region.",
      imageUrl: AchievementImage,
    },
    {
      title: "Sports Excellence",
      description:
        "Our students have excelled in regional and national sports events.",
      imageUrl: AchievementImage,
    },
    {
      title: "Community Service",
      description:
        "Our students have actively participated in numerous community service projects.",
      imageUrl: AchievementImage,
    },
    {
      title: "Innovative Education Programs",
      description:
        "We have introduced several innovative educational programs to enhance learning.",
      imageUrl: AchievementImage,
    },
  ];
      ...
      <Slider {...settings}>
        {achievements.map((achievement, index) => (
          <div key={index} className="achievement-slide">
            <div
              className="relative bg-white p-4 rounded-lg overflow-hidden"
