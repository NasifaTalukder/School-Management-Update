  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-lg flex flex-col items-center text-center w-full">
      <img
        src={PrincipalImage}
        alt="Principal"
        className="w-24 h-24 object-cover rounded-full border-4 border-gray-300 shadow-lg mb-4"
      />
      ...
      <button className="px-4 py-2 bg-main-color text-white rounded-btn-radius hover:bg-secondary-colour">
        VIEW MORE →
      </button>
